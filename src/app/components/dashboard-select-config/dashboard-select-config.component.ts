...
@Component({
  selector: 'dashboard-select-config',
  templateUrl: './dashboard-select-config.component.html',
  styleUrls: ['./dashboard-select-config.component.scss']
})
export class DashboardSelectConfigComponent implements OnInit, OnDestroy {
